...
Texture::Texture(const std::string& filepath) : id_(0), file_buffer_(nullptr), width_(0), height_(0), Bpp_(0)
{
	...
	GLCall(glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA8, width_, height_, 0, GL_RGBA, GL_UNSIGNED_BYTE, static_cast<void*>(file_buffer_)));
